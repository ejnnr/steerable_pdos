...
from e2cnn import gspaces, kernels, diffops
...
class Flip2dOnR2(GeneralOnR2):
    ...
    def _basis_generator(self,
        ...
        if method == "kernel":
            return kernels.kernels_Flip_act_R2(in_repr, out_repr, kwargs["rings"], kwargs["sigma"],
                                            axis=self.axis,
                                            max_frequency=maximum_frequency,
                                            max_offset=maximum_offset)
        elif method == "diffop":
            return diffops.kernels_Flip_act_R2(in_repr, out_repr, kwargs["max_power"],
                                            axis=self.axis,
                                            max_frequency=maximum_frequency,
                                            max_offset=maximum_offset)
        else:
