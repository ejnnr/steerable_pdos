...
class TrivialOnR2(GeneralOnR2):
    ...
    def _basis_generator(self,
        ...
        """
        if method != "kernel":
            raise NotImplementedError("Only steerable kernels are implemented so far for the trivial group.")
        ...
        return kernels.kernels_Trivial_act_R2(in_repr, out_repr, kwargs["rings"], kwargs["sigma"],
                                              maximum_frequency,
